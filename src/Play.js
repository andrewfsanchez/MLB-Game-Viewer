...
function Play({play, index}){
    ...
    return (
        <x.div boxSizing="border-box" justifyContent="center"  pt={2}>
            <x.div  boxSizing="border-box" h="35" w={{xs:"80%", md:"45%"}} ml={{xs:"10%",md:"20%"}} border={1} p={1} display="flex" justifyContent="space-between" bg='#213a40' onClick={()=>setActive(!active)} cursor="pointer">
